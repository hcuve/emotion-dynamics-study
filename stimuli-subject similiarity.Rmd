...
db_ASC_NT_2023_NT<-   db_ASC_NT_2023_NT%>%select(c(1:4,84,86,88,24,6:8,10,15))
colnames(db_ASC_NT_2023_NT)
...
DT_wide <- melt(db_ASC_NT_2023_NT[,c(1,3,7,8,13,9:12)], id.vars = c("ParticipantPrivateID", "Emotion", "DATASET","face_unique", "VideoType"),
...
DT_wide2 <- dcast(DT_wide, ParticipantPrivateID + Emotion + DATASET + face_unique ~ paste0(Metric, "_", VideoType),
                 value.var = "Value",
                 fun.aggregate = mean,
                 na.rm = TRUE)
...
DT_wide2$AnswerRating_Intensity_Morph- DT_wide2$AnswerRating_Intensity_Original
...
table(DT_wide2naomit$ParticipantPrivateID)
...
table(DT_wide2naomit$ParticipantPrivateID, DT_wide2naomit$DATASET)
